  ...
  return (
    <div className="pt-24 pb-16">
      <h3 
        ...
        className="font-bold text-2xl md:text-4xl italic tracking-wider text-center  px-5 py-2 bg-[#C4DFDF] text-gray-600 w-full md:w-1/2 mx-auto  "
      >
        Shop by category
      </h3>
      
      <div className="max-w-7xl relative mx-auto  px-5">
      <div  className="absolute -top-52 left-0 md:-top-44 md:left-32">
      <Lottie  
      ...
      <Lottie 
        ...
        <Tabs >
          ...
          <TabPanel>
            <div className="grid px-2 md:grid-cols-2 gap-5  lg:grid-cols-3 justify-center">
                {
